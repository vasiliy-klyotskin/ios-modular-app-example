...
struct DemoUtilsMainView: View {
    @ObservedObject var vm: DemoUtilsMainViewModel
    ...
    private func rootItemContent(for item: DemoUtilsMainViewModel.MainViewItem) -> some View {
        HStack(spacing: 16) {
